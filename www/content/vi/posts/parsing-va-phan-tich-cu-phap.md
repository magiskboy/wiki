...
<figure>
<img src="/images/parser.png" alt="Cấu trúc cơ bản của compiler/transpiler">
<figcaption>Cấu trúc cơ bản của compiler/transpiler</figcaption>
</figure>
...
<figure>
<img src="/images/ast.dot.svg" alt="AST của biểu thức: (1 + 1 * 2) / (3 + 5 * 8 - 13)">
<figcaption>AST của biểu thức: (1 + 1 * 2) / (3 + 5 * 8 - 13)</figcaption>
</figure>
