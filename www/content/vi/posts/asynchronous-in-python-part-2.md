...
Đây là bài viết tiếp theo của mình trong chuỗi bài viết về lập trình bất đồng bộ trong Python. Các bạn có thể theo dõi bài viết trước của mình về [coroutine](/posts/bat-dong-bo-trong-python-phan-1-coroutine) trước khi đọc bài viết này nhé. Giờ thì cùng bắt đầu thôi, Let's go
...
<figure>
<img src="/images/eventLoop-full.svg" alt="Event loop">
...
<figure>
<img src="/images/Untitled Diagram-2.png" alt="Vòng lặp sự kiện với một task (coroutine)">
<figcaption>Vòng lặp sự kiện với một task (coroutine)</figcaption>
</figure>
